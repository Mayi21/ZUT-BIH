...
<main>
    <div class="container">
        <form action="/toLogin" method="post" class="form-signin">
            <h2 class="form-signin-heading">账户登录</h2>
            <input type="email" name="email" autofocus="" class="form-control" placeholder="请输入邮箱" maxlength="254" required="" id="id_username">
            <br>
            ...
            <div class="checkbox">
                <label><a href="/changePassword" style="float:right">忘记密码</a>
            </div>
            <button id="login" class="btn btn-lg btn-primary btn-block" type="submit">登录</button>
        </form>
        <div class="form-signin">
            <p>没有账户?<a id="register" href="/register">注册一个</a></p>
        </div>
    </div>
...
<link rel="stylesheet" type="text/css" href="/static/static/custom/css/footer.css">
</head>
