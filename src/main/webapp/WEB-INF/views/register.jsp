...
<main>
    <div class="container">
        <form action="/toRegister" method="post" class="form-signin">
            <h2 class="form-signin-heading">注册账户</h2>

            <div class="form-group">
                <label for="id_email" title="">邮箱
                </label> <input type="email" name="email" class="form-control" maxlength="255" required="" id="id_email" placeholder="请输入注册的邮箱">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="id_first_names" title="">用户名
                </label> <input type="text" name="username" class="form-control" maxlength="100" required="" id="username" placeholder="请输入用户名">

            </div>
            <div class="form-group">
                <label for="id_first_names" title="">密码
                </label> <input type="password" name="password" class="form-control" maxlength="100" required="" id="id_first_names" placeholder="请输入注册密码">
            </div>
